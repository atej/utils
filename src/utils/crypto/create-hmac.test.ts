...
describe('createHmac', () => {
  ...
  it('should handle empty string message', () => {
    ...
    expect(hmac).toBe(
      '345fba21f06a4f75ed673fb93dc16cd47d8dc7a69f52e84e3016fcf69835fdb8',
    )
  })
  ...
  it('should handle unicode characters in message', () => {
    ...
    expect(hmac).toBe(
      '122598e35d8dc10cf0a3654a23105618d7a2250a556c4cff52afb6e60938acde',
    )
  })
  ...
  it('should handle unicode characters in key', () => {
    ...
    expect(hmac).toBe(
      '8ca399c42b85ed745e798993f5ad04d052b88a6f9bb5ee6220be143b4d6e1c8e',
    )
  })
  ...
  it('should work with different encodings', () => {
    const message = 'test'
    const key = 'secret-key'
    const encodings: Array<CreateHmacOptions['encoding']> = [
      'hex',
      'base64',
      'base64url',
    ]
  ...
  it('should merge options correctly', () => {
    ...
    const hmac2 = createHmac(message, key, {
      algorithm: 'md5',
      encoding: 'hex',
    })
