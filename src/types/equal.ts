 ...
 *
 * @remarks
 * This type uses a technique where it creates conditional types
 * that are only equal if the underlying types are structurally identical.
 * The conditional type `(<T>() => T extends X ? 1 : 2)` creates a unique
 * type signature that depends on the exact structure of X and Y.
 */
